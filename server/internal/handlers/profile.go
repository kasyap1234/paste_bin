...
//	@Accept			json
//	@Produce		json
//	@Success		200	{object}	models.User			"Profile retrieved successfully"
//	@Failure		500	{object}	map[string]string	"Failed to get profile"
//	@Security		BearerAuth
//	@Router			/profile [get]
...
//	@Accept			json
//	@Produce		json
//	@Param			request	body		models.PatchProfile	true	"Profile update data"
